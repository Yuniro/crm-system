# Generated by Django 3.0.8 on 2020-07-09 12:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employer_lead_type', models.CharField(choices=[['fixed', 'фиксированая ставка'], ['percent', 'процент от сделки']], max_length=100)),
                ('employer_lead_amount', models.FloatField()),
                ('employer_type', models.CharField(choices=[['fixed', 'фиксированая ставка'], ['percent', 'процент от сделки']], max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='crm.Payment')),
            ],
        ),
        migrations.CreateModel(
            name='Tour',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='crm.Company')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='crm.Client')),
            ],
        ),
        migrations.CreateModel(
            name='ExchangeRate',
            fields=[
                ...
                ('currency', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='crm.Currency')),
            ],
        ),
        migrations.CreateModel(
            name='Employer',
        ...
        migrations.AddField(
            model_name='client',
            name='company',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='crm.Company'),
        ),
        migrations.AddField(
            model_name='client',
            name='employer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='crm.Employer'),
        ),
        migrations.AddField(
            model_name='client',
            name='employer_lead',
